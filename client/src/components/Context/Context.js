...
const AppProvider = ({ children }) => {
  ...
  const fetchHighPriority = () => {
    axios
      .get(`https://project-management-app-5swq.onrender.com/highPriority`, {
        headers,
      })
      .then((response) => {
  ...
  const fetchModeratePriority = () => {
    axios
      .get(
        `https://project-management-app-5swq.onrender.com/moderatePriority`,
        { headers }
      )
      .then((response) => {
  ...
  const fetchLowPriority = () => {
    axios
      .get(`https://project-management-app-5swq.onrender.com/lowPriority`, {
        headers,
      })
      .then((response) => {
  ...
  const fetchBacklogTodoTask = () => {
    axios
      .get(`https://project-management-app-5swq.onrender.com/backlogTodoTask`, {
        headers,
      })
      .then((response) => {
  ...
  const fetchCompletedTodoTask = () => {
    axios
      .get(
        `https://project-management-app-5swq.onrender.com/completedTodoTask`,
        { headers }
      )
      .then((response) => {
  ...
  const fetchCurrentTodoTask = () => {
    axios
      .get(`https://project-management-app-5swq.onrender.com/currentTodoTask`, {
        headers,
      })
      .then((response) => {
  ...
  const fetchProgressTodoTask = () => {
    axios
      .get(
        `https://project-management-app-5swq.onrender.com/progressTodoTask`,
        { headers }
      )
      .then((response) => {
  ...
  const fetchDueDateTodoTask = () => {
    axios
      .get(`https://project-management-app-5swq.onrender.com/dueDateTodoTask`, {
        headers,
      })
      .then((response) => {
